          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <AnimatedCard>
              <CourseLevel
                ...
                level="intermediate"
                offeringId="course-ai-intermediate"
              />
            </AnimatedCard>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <AnimatedCard>
              <CourseLevel
                ...
                level="advanced"
                offeringId="course-coding-advanced"
              />
            </AnimatedCard>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <AnimatedCard>
              <CourseLevel
                ...
                level="beginner"
                offeringId="course-math-beginner"
              />
            </AnimatedCard>
            ...
            <AnimatedCard>
              <CourseLevel
                ...
                level="intermediate"
                offeringId="course-math-intermediate"
              />
            </AnimatedCard>
            ...
            <AnimatedCard>
              <CourseLevel
                ...
                level="advanced"
                offeringId="course-math-advanced"
              />
            </AnimatedCard>
          </div>
        </section>
