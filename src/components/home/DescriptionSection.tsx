    ...
    return (
      <section className="py-6 sm:py-8 bg-[#FAF9F6] w-full overflow-x-hidden">
        ...
        <motion.div
          ...
          className="flex flex-col items-center justify-center w-full max-w-xl mx-auto p-4 sm:p-5 md:p-6 bg-[#E0F2F7] rounded-lg shadow-md my-5 sm:my-8 sm:mx-auto border-t-4 border-[#FFC000]"
        >
