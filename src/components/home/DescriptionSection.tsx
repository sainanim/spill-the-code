  ...
  return (
    <section className="py-6 sm:py-8 bg-[#FAF9F6] w-full overflow-hidden">
      <div className="container mx-auto px-3 sm:px-6">
        ...
        <div className="flex flex-col md:flex-row gap-5 lg:gap-8 max-w-6xl mx-auto w-full">
          ...
          <motion.div
            ...
            className="w-full md:w-1/2 mb-5 md:mb-0 px-2 sm:px-0"
          >
            <div className="h-full w-full bg-gradient-to-br from-[#FAF9F6] to-[#E0F2F7] border-l-4 border-[#FFC000] shadow-lg rounded-lg overflow-hidden p-3 sm:p-5 lg:p-6">
              ...
              >
                <motion.li variants={listItem} className="flex items-start">
                  <span className="inline-flex items-center justify-center bg-[#1976D2] text-[#FAF9F6] rounded-full w-4 h-4 sm:w-5 sm:h-5 mr-1.5 sm:mr-2 mt-0.5 flex-shrink-0 text-xs">•</span>
      ...
      <motion.div
        ...
        className="flex flex-col items-center justify-center w-full max-w-xl mx-auto p-3 sm:p-5 md:p-6 bg-[#E0F2F7] rounded-lg shadow-md my-4 sm:my-8 mx-3 sm:mx-auto border-t-4 border-[#FFC000]"
      >
